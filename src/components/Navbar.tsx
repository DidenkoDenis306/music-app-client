...
const menuItems = [
  { text: "Home", icon: <HouseIcon />, href: "/" },
  { text: "Albums", icon: <AlbumIcon />, href: "/albums" },
  { text: "Tracks", icon: <LibraryMusicIcon />, href: "/tracks" },
  { text: "Genres", icon: <MusicNoteIcon />, href: "/genres" },
  { text: "Upload Track", icon: <FileUploadIcon />, href: "/tracks/create" },
];
